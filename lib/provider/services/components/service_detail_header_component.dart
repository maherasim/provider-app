                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          PriceWidget(
                            ...
                            isDailyService: widget.serviceDetail.isDailyService,
                            isFixesService: widget.serviceDetail.isFixedService,
                            size: 16,
                      ...
                      TextIcon(
                        ...
                        expandedText: true,
                        suffix: Text(
                          "${widget.serviceDetail.minimumBookings.validate()}",
                          style: boldTextStyle(color: primaryColor),
                        ),
                      ),
                    ],

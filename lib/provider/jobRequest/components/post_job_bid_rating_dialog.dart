...
class PostJobBidRatingDialog extends StatefulWidget {
  final int postJobBidId;
  ...
  PostJobBidRatingDialog({
    required this.postJobBidId,
  ...
  @override
  _PostJobBidRatingDialogState createState() => _PostJobBidRatingDialogState();
}

class _PostJobBidRatingDialogState extends State<PostJobBidRatingDialog> {
  double rating = 0.0;
  ...
  void _submitRating() {
    ...
    Map request = {
      "post_job_bid_id": widget.postJobBidId,
    ...
    savePostJobBidProviderRating(request).then((res) {

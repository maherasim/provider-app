...
class LanguageAr extends Languages {
  ...
  String get pleaseContactYourAdmin =>
      'حسابك غير نشط. يرجى الاتصال بمسؤول النظام.';
  ...
  String get serviceProofMediaUploadNote =>
      'ملحوظة: يمكنك تحميل صورة بامتداد ""JPG""، ""PNG""، ""JPEG"" ويمكنك تحديد صور متعددة';
  ...
  String get permissionDeniedUnableTo =>
      'تم رفض الإذن! غير قادر على تحرير العامل الماهر';
  ...
  @override
  String get lblCountryTax => 'ضريبة الدولة';

  @override
  String get lblMinBooking => 'الحد الأدنى للحجز';

  @override
  String get lblCancellationPolicy => 'سياسة الإلغاء';

  @override
  String get waitingForAdvancePayment => 'في انتظار الدفع المسبق';

  @override
  String get waitingForPaymentApproval => 'في انتظار الموافقة على الدفع';
  ...
  String get workInProgressWaitingForProvider =>
      "العمل قيد التقدم — في انتظار المزود للتحديث أو الإنجاز";
  ...
  @override
  String get doYouWantToHoldThisBid => "هل تريد تعليق هذا العرض؟";

  @override
  String get updatePaymentSplit => 'تحديث تقسيم الدفع';

  @override
  String get advancePercentageShouldBeBetween =>
      "يجب أن تكون النسبة المئوية المقدمة بين 1 و 99.";

  @override
  String get advancePercentage => "النسبة المئوية المقدمة";

  @override
  String get remainingPercentage => "النسبة المئوية المتبقية";

  // Additional Job Request strings
  @override
  String get addExtraCharges => 'إضافة رسوم إضافية';
  ...
  String get extraChargesWillBeIncludedInFinalInvoice =>
      'ستُدرج الرسوم الإضافية في الفاتورة النهائية.';
  ...
  @override
  String get quantityMustBeAtLeast1 => 'يجب أن تكون الكمية على الأقل 1';
  ...
  String get waitingForProviderToResumeWork =>
      'في انتظار المزود لاستئناف العمل';
  ...
  @override
  String get lblPartTime => 'دوام جزئي';

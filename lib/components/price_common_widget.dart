                ...
                Row(
                  ...
                  children: [
                    Text(languages.hintPrice,
                        ...
                        .expand(),
                    PriceWidget(
                            price: serviceDetail.price.validate(),
              ...
              children: [
                ...
                Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(languages.lblQuantity, style: secondaryTextStyle(size: 14))
                ...
                Column(
                  children: [
                    Row(
                      children: [
                        Text(languages.lblTotal, style: secondaryTextStyle(size: 14))
                            .expand(),
                        16.width,
                        Marquee(
                          child: Row(

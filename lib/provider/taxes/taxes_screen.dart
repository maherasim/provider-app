...
class _TaxesScreenState extends State<TaxesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: UniqueKey(),
      appBar: AppBar(
        title: Text(languages.lblTaxes, style: boldTextStyle(color: Colors.white, size: APP_BAR_TEXT_SIZE)),
        elevation: 0,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  isCommissionTypePercent(data.type) ? ' ${data.value.validate()}%' : ' ${data.value.validate().toPriceFormat()}',
                                  style: boldTextStyle(),
                                ),
